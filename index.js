...
app.use(cors({
    origin: ['https://admin.spexafrica.app','https://admin.spexafrica.site', 'https://user.spexafrica.app', 'https://user.spexafrica.site', 'https://vendor.spexafrica.app','https://vendor.spexafrica.site', 'https://enterprise.spexafrica.app',  'https://enterprise.spexafrica.site', 'http://localhost:3000', 'http://localhost:3001'],
